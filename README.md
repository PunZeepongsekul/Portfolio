...
## Cursor IDE Setup
1. Download and install the Cursor IDE.
2. Connect Cursor to my GitHub account (Grant access to the "Portfolio" repository only).
3. Install the Codex (OpenAI), Claude Code (Anthropic), and Gemini Code Assist / Gemini CLI (Google) extensions within Cursor.

## Push Project Files to GitHub
1. Install Command Line Tools
2. Create a README.md file in Cursor and document the project details.
3. Use the Cursor AI Agent to push this file to my GitHub repository by using this prompt:

" Push 'README.md' files to my 'Portfolio' GitHub repository using this URL 'https://github.com/PunZeepongsekul/Portfolio.git' "
...
- **Cause:** Due to a recent version update, Cursor directs users to the Agent window by default NOT Editor Window.

- **Solution:** After exploring the app and tutorial, I located the extensions within the Editor Window


### Challenge 3: Unable to login to Claude Code in Cursor
